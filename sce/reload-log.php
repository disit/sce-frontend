...
<html>
    <head> 
        ...
        <script type="text/javascript">
            ...
            function refreshTable() {
                ...
                //load table
                $('#tableHolder').load('log.php' + (location.search != '' ? (location.search + '&' + filters) : '?' + filters), function () {
                    setTimeout(refreshTable, <?php echo $config['refreshTime']; ?>);
                });
            }

            //called by clicking on a sort field in log.php and by $(document).ready of this php
            function loadTable(sortFilters) {
                ...
                //load table
                //if sortFilters is defined (called by log.php) set global sort filters with current values
                if (sortFilters) {
    ...
    <body>
        ...
        <div id='filtersTable'>
            <table>
                <tr class='even' >
                    ...
                    <td><input type="text" name="FILTER_LOGGER" class="FILTER" id="FILTER_LOGGER"></td>
                    <td><input type="text" name="FILTER_LEVEL" class="FILTER" id="FILTER_LEVEL"></td>
                    <td><input type="text" name="FILTER_MESSAGE" class="FILTER" id="FILTER_MESSAGE"></td>
                </tr>
            </table>
        </div>
        ...
        <br><br>
        <!--<a class="pointer button" title="Back" href="#" onclick="history.back();">Back</a>&emsp;-->
