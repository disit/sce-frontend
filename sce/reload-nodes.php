...
<html>
    <head> 
        ...
        <script type="text/javascript">
            ...
            function refreshTable() {
                ...
                //load table
                $('#tableHolder').load('nodes.php' + (location.search != '' ? (location.search + '&' + filters) : '?' + filters), function () {
                    setTimeout(refreshTable, <?php echo $config['refreshTime']; ?>);
                });
            }

            //called by clicking on a sort field in nodes.php and by $(document).ready of this php
            function loadTable(sortFilters) {
                ...
                //load table
                //if sortFilters is defined (called by nodes.php) set global sort filters with current values
                if (sortFilters) {
    ...
    <body>
        ...
        <a class="pointer button" class="pointer button" title="Back" href="#" onclick="if (document.referrer) {
